...
#define CLIPPER_INTPOINT_IMPL mapnik::geometry::point<std::int64_t>
#define CLIPPER_PATH_IMPL mapnik::geometry::line_string<std::int64_t>
#define CLIPPER_PATHS_IMPL mapnik::geometry::multi_line_string<std::int64_t>
